...
{
private:
	const double radarNIS5percentBoundary = 5.991;
	const double lidarNIS5percentBoundary = 7.815;

	int nisRadarValuesComputed = 0;
	int nisLidarValuesComputed = 0;

	int nisRadarValuesAboveThreshold = 0;
	int nisLidarValuesAboveThreshold = 0;
